...
# Crear etiqueta para el título del formulario
etiqueta1 = tkinter.Label(principal, text="FORMULARIO DE REGISTRO", bg="black", font=("Arial", 14), fg="red")

# Crear un marco para organizar los elementos del formulario
marco1 = tkinter.Frame(principal, bd=0, relief="groove")
...
etiqueta7 = tkinter.Label(marco1, text="Poblacion:")
